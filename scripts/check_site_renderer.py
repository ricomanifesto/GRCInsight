...
assert(metadata.renderWorkspaceOverview(auditSummary).includes(needsCopy.workspaceCopy), 'workspace overview should consume canonical summary copy');
...
assert(metadata.renderAuditSummary(auditSummary).includes(needsCopy.auditCopy), 'audit summary renderer should consume canonical summary copy');
...
const readyCopy = metadata.auditSummaryCopy(filteredAuditSummary);
assert(readyCopy.workspaceCopy === '1 visible sections mapped across obligations, controls, gaps, owner cues, and source provenance.', 'ready summary copy should preserve filtered workspace count');
assert(readyCopy.auditCopy === '1 sections reviewed for obligations, gaps, deadlines, and evidence trails.', 'ready summary copy should preserve filtered audit count');
...
const emptyCopy = metadata.auditSummaryCopy(emptyFilteredAuditSummary);
assert(emptyCopy.workspaceCopy === '0 visible sections mapped across obligations, controls, gaps, owner cues, and source provenance.', 'empty summary copy should preserve zero workspace count');
assert(emptyCopy.auditCopy === '0 sections reviewed for obligations, gaps, deadlines, and evidence trails.', 'empty summary copy should preserve zero audit count');
