(function () {
  const categories = [
    ...
    },
    {
      ...
      pillClass: 'risk',
      terms: [
        { label: 'Ransomware', aliases: ['Ransomware'] },
        { label: 'Extortion', aliases: ['Extortion'] },
        { label: 'Third-party', aliases: ['Third-party'] },
        { label: 'Identity', aliases: ['Identity'] },
        { label: 'Cloud misconfiguration', aliases: ['Cloud misconfiguration'] },
        { label: 'BEC', aliases: ['BEC'] },
      ],
    },
    {
      key: 'controls',
      ...
      pillClass: 'control',
      terms: [
        { label: 'Access Control', aliases: ['Access Controls', 'Access Control'] },
        { label: 'Controls', aliases: ['Controls'] },
        { label: 'Control', aliases: ['Control'] },
        { label: 'IAM', aliases: ['IAM'] },
        { label: 'Encryption', aliases: ['Encryption'] },
        { label: 'Logging', aliases: ['Logging'] },
        { label: 'Incident Response', aliases: ['Incident Response'] },
        { label: 'Vendor Risk', aliases: ['Vendor Risk'] },
      ],
    },
    {
      key: 'agencies',
