.PHONY: test-go test-agent lint-agent format-agent type-agent check-agent check-go-format check-site check e2e fmt-go
...
check: check-go-format test-go check-agent check-site
